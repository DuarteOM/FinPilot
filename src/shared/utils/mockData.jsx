...
export const TREND = [
  { m: "Jan", income: 2400, expense: 1680 },
  { m: "Fev", income: 2400, expense: 1820 },
  { m: "Mar", income: 2550, expense: 1900 },
  { m: "Abr", income: 2400, expense: 1740 },
  { m: "Mai", income: 2700, expense: 2010 },
  { m: "Jun", income: 2400, expense: 1590 },
  { m: "Jul", income: 2650, expense: 1860 },
];

export const REPORT_DATA = [
  { m: "Jan", income: 2400, expense: 1680, saved: 720 },
  { m: "Fev", income: 2400, expense: 1820, saved: 580 },
  { m: "Mar", income: 2550, expense: 1900, saved: 650 },
  { m: "Abr", income: 2400, expense: 1740, saved: 660 },
  { m: "Mai", income: 2700, expense: 2010, saved: 690 },
  { m: "Jun", income: 2400, expense: 1590, saved: 810 },
  { m: "Jul", income: 2650, expense: 1860, saved: 790 },
];

export const CATS = [
  { name: "Restauração", value: 412, color: "#E8A33D", icon: Utensils },
  { name: "Supermercado", value: 358, color: "#5DCAA5", icon: ShoppingBag },
  { name: "Transportes",  value: 196, color: "#7F8FE4", icon: Fuel },
  { name: "Subscrições",  value: 64,  color: "#D4537E", icon: Film },
  { name: "Casa",         value: 540, color: "#888780", icon: Home },
];
...
export const CHAT0 = [
  { role: "assistant", text: "Olá! Sou o FinPilot. Este mês já gastaste 1.570€ — 6% abaixo da média. Como posso ajudar?" },
];
